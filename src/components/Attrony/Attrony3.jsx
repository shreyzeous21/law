    ...
    <div className="row">
      <div className="section-title-area sibling2">
        ...
        <div className="section-title sibling2">
          <span>CREATIVE TEAM</span>
          <h2 className="text-white">We have the most experienced lawyers.</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="row">
      <div className="col-12">
        <Swiper {...attronySlider} className="swiper attorney-slider pb-65">
          <div className="swiper-wrapper">
            ...
            <SwiperSlide className="swiper-slide wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.6s">
              <div className="attorney-single sibling3">
                ...
                <div className="content">
                  <h4><Link href="/lawyer-details"><a>Michael Mason</a></Link></h4>
                  <p>Criminal Lawyer</p>
                </div>
                <ul className="social-list2 gap-3">
                  <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
          ...
          <div className="swiper-pagination attrony3 d-flex align-items-center justify-content-center" />
        </Swiper>
      </div>
    </div>
  </div>
